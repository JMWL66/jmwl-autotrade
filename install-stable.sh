...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/JMWL66/jmwl-autotrade/release/stable/install-stable.sh | bash
#
...
GITHUB_RAW="https://raw.githubusercontent.com/JMWL66/jmwl-autotrade/release/stable"
