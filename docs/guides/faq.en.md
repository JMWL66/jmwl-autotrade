...
See [Issue #202](https://github.com/JMWL66/jmwl-autotrade/issues/202) and [Troubleshooting Guide](TROUBLESHOOTING.md#-only-opening-short-positions-issue-202).
...
2. Search [existing issues](https://github.com/JMWL66/jmwl-autotrade/issues)
3. If not found, use our [Bug Report Template](../../.github/ISSUE_TEMPLATE/bug_report.md)

### Where can I get help?
- [GitHub Discussions](https://github.com/JMWL66/jmwl-autotrade/discussions)
- [Telegram Community](https://t.me/nofx_dev_community)
- [GitHub Issues](https://github.com/JMWL66/jmwl-autotrade/issues)
...
Open a [Feature Request](https://github.com/JMWL66/jmwl-autotrade/issues/new/choose) with your idea!
