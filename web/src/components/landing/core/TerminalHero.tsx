...
export default function TerminalHero() {
    ...
    return (
        <section className="relative w-full min-h-screen bg-jmwl-bg text-jmwl-text overflow-hidden flex flex-col pt-20">
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none">
                <div className="w-[80vw] h-[80vw] rounded-full border border-jmwl-gold/20 animate-pulse-slow"></div>
                <div className="absolute w-[60vw] h-[60vw] rounded-full border border-dashed border-jmwl-accent/20 animate-[spin_60s_linear_infinite]"></div>
            </div>

            {/* 3. Gradient Spots - Intensified for Mobile */}
            <div className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-jmwl-gold/20 rounded-full blur-[120px] pointer-events-none mix-blend-screen"></div>
            <div className="absolute bottom-[-10%] right-[-10%] w-[40vw] h-[40vw] bg-jmwl-accent/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen"></div>

            {/* Mobile Bottom Fade */}
            <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-jmwl-bg to-transparent z-20 pointer-events-none md:hidden" />

            {/* Mobile Floating HUD */}
            <div className="md:hidden absolute top-24 right-4 z-0 opacity-30 pointer-events-none">
                <div className="w-20 h-20 border border-dashed border-jmwl-gold/30 rounded-full animate-spin-slow flex items-center justify-center">
                    <div className="w-12 h-12 border border-jmwl-accent/30 rounded-full"></div>
                </div>
            </div>
            ...
            <div className="relative z-10 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-0 lg:gap-8 max-w-[1800px] mx-auto w-full px-6 h-full pb-20 pt-10 pointer-events-none">
                ...
                <div className="hidden lg:flex col-span-3 flex-col justify-between h-full border-r border-white/5 pr-8 py-10 pointer-events-auto">
                    ...
                    <div className="space-y-6">
                        <div className="tech-border p-4 bg-black/40 backdrop-blur-sm">
                            <h3 className="text-xs font-mono text-jmwl-gold mb-4 flex items-center gap-2">
                            ...
                            <div className="space-y-3 font-mono text-[10px] text-zinc-400">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-jmwl-accent">12ms</span>
                                </div>
                                <div className="w-full h-1 bg-zinc-800 rounded-full overflow-hidden">
                                    <div className="w-[90%] h-full bg-jmwl-accent/50"></div>
                                </div>

                                <div className="flex justify-between items-center">
                                    <span>MEMORY_INTEGRITY</span>
                                    <span className="text-jmwl-success">100%</span>
                                </div>
                                <div className="w-full h-1 bg-zinc-800 rounded-full overflow-hidden">
                                    <div className="w-full h-full bg-jmwl-success/50"></div>
                                </div>
                        ...
                        <div className="p-4 border border-zinc-800/50 rounded bg-zinc-900/20">
                            ...
                            <div className="flex gap-1">
                                <div className="h-1 flex-1 bg-jmwl-gold"></div>
                                <div className="h-1 flex-1 bg-jmwl-gold"></div>
                                <div className="h-1 flex-1 bg-jmwl-gold"></div>
                                <div className="h-1 flex-1 bg-zinc-800"></div>
                            </div>
                            <div className="mt-2 text-right text-[10px] text-jmwl-gold/80 font-mono">LEVEL 3 ACTIVATE</div>
                        </div>
                    </div>
                ...
                <div className="col-span-1 lg:col-span-6 flex flex-col items-center justify-center text-center relative z-20 pointer-events-auto">
                    ...
                    <motion.div
                        ...
                        className="mb-8 inline-flex items-center gap-3 px-4 py-2 rounded-full border border-jmwl-gold/20 bg-jmwl-gold/5 backdrop-blur-md"
                    >
                        <span className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-jmwl-gold opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-jmwl-gold"></span>
                        </span>
                        <span className="text-xs font-mono text-jmwl-gold tracking-widest">加密未来开源 AI 核心</span>
                    </motion.div>
                    ...
                    <div className="relative z-20 mix-blend-hard-light md:mix-blend-normal">
                        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black tracking-tighter leading-[1.1] md:leading-[1.0] mb-6 select-none bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-zinc-600 drop-shadow-2xl font-sans">
                            加密未来<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-jmwl-gold via-white to-jmwl-gold animate-shimmer bg-[length:200%_auto] tracking-tight filter drop-shadow-[0_0_15px_rgba(234,179,8,0.3)] whitespace-nowrap">交易系统Pro</span>
                        </h1>
                    ...
                    <div className="flex flex-col gap-4 mb-14">
                        <div className="text-jmwl-gold/80 font-mono text-xs tracking-[0.3em] uppercase flex items-center gap-2 ml-1">
                            <span className="relative flex h-2 w-2">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-jmwl-success opacity-75"></span>
                                <span className="relative inline-flex rounded-full h-2 w-2 bg-jmwl-success"></span>
                            </span>
                        ...
                        <div className="flex flex-wrap gap-4 font-mono">
                            {['CRYPTO', 'US STOCKS', 'FOREX', 'METALS'].map((market) => (
                                <div key={market} className="relative group cursor-default">
                                    <div className="absolute -inset-0.5 bg-gradient-to-r from-jmwl-gold/20 to-blue-600/20 rounded-lg blur opacity-0 group-hover:opacity-100 transition duration-500"></div>
                                    <div className="relative flex items-center gap-3 px-6 py-3 rounded-lg bg-zinc-900/80 border border-zinc-700 hover:border-jmwl-gold/50 transition-all duration-300 backdrop-blur-sm">
                                        <div className="w-1.5 h-1.5 rounded-full bg-jmwl-success shadow-[0_0_8px_rgba(74,222,128,0.6)] animate-pulse"></div>
                                        <span className="text-lg md:text-xl font-bold text-white tracking-wider group-hover:text-jmwl-gold transition-colors">{market}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="w-full max-w-lg h-12 bg-black/50 border border-zinc-800 rounded flex items-center px-4 mb-10 font-mono text-sm shadow-2xl backdrop-blur-sm group hover:border-jmwl-gold/50 transition-colors cursor-text" onClick={() => document.getElementById('market-scanner')?.scrollIntoView({ behavior: 'smooth' })}>
                        <span className="text-jmwl-success mr-2">➜</span>
                        <span className="text-jmwl-accent mr-2">~</span>
                        <span className="text-zinc-500">deploy agent --strategy=hft</span>
                        <span className="w-2 h-4 bg-jmwl-gold ml-1 animate-pulse"></span>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                        <button
                            ...
                            className="group relative overflow-hidden bg-jmwl-gold text-black px-8 py-4 font-bold font-mono tracking-wider hover:scale-105 transition-transform duration-200"
            ...
            <div className="absolute top-0 right-0 h-full w-[50vw] hidden lg:flex flex-col items-end justify-end pr-8 pb-20 z-10">
                {/* Subtle gradient orb */}
                <div className="absolute top-1/2 right-[10%] -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-gradient-to-br from-jmwl-gold/10 via-jmwl-gold/5 to-transparent blur-[100px] pointer-events-none"></div>
            ...
            <div className="absolute bottom-0 w-full bg-black/80 border-t border-zinc-800/50 backdrop-blur-md z-30 overflow-hidden py-2 flex items-center">
                <div className="flex animate-marquee whitespace-nowrap gap-12 text-xs font-mono text-zinc-500 px-4">
                    ...
                    <span className="flex items-center gap-2 text-jmwl-gold"><Zap className="w-3 h-3" /> FLASH LOANS ENABLED</span>
                    ...
                    {Object.entries(prices).map(([symbol, price]) => (
                        <span key={symbol} className="flex items-center gap-2">
                            {symbol.toUpperCase()}/USDT <span className="text-jmwl-success">${price}</span>
                        </span>
                    ))}

                    <span className="flex items-center gap-2"><CircuitBoard className="w-3 h-3 text-jmwl-accent" /> AI MODEL: Claude Opus 4.6</span>
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-4xl">
            {stats.map((stat, i) => (
                <a
                    ...
                    className="flex flex-col items-center justify-center p-3 rounded bg-black/40 border border-zinc-800/50 backdrop-blur-sm group hover:border-jmwl-gold/30 transition-all cursor-pointer hover:bg-white/5"
                >
                    <div className="flex items-center gap-2 mb-1">
                        <stat.icon className={`w-4 h-4 ${stat.color}`} />
                        <span className="text-[10px] font-mono text-zinc-500 tracking-wider">{stat.label}</span>
                    </div>
                    <span className="text-xl font-bold font-mono text-white group-hover:text-jmwl-gold transition-colors">{stat.value}</span>
                </a>
            ))}
        </div>
    )
