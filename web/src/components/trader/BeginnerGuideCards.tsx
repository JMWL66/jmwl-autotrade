  ...
  return (
    <section className="space-y-4 rounded-[28px] border border-white/10 bg-zinc-950/60 p-5 backdrop-blur-xl">
      <div className="flex items-center justify-between gap-4">
        <div>
          <div className="text-xs font-semibold uppercase tracking-[0.3em] text-jmwl-gold/80">
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/6 text-jmwl-gold">
              ...
              <button
                ...
                className={`mt-5 w-full rounded-2xl px-4 py-3 text-sm font-semibold transition ${
                  card.disabled
                    ...
                    : 'bg-jmwl-gold text-black hover:bg-yellow-400'
                }`}
              >
                {card.actionLabel}
              </button>
