        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-white/10 pb-6">
          <div className="flex items-center gap-4">
            <div className="relative group">
              <div className="absolute -inset-1 bg-jmwl-gold/20 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-500"></div>
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl flex items-center justify-center bg-black border border-jmwl-gold/30 text-jmwl-gold relative z-10 shadow-[0_0_15px_rgba(240,185,11,0.1)]">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold font-mono tracking-tight text-white flex items-center gap-3 uppercase">
                ...
                <span className="text-xs font-mono font-normal px-2 py-0.5 rounded bg-jmwl-gold/10 text-jmwl-gold border border-jmwl-gold/20 tracking-wider">
