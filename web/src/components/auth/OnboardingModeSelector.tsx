          ...
          return (
            <button
              ...
              className={`w-full rounded-xl border px-4 py-3 text-left transition-all ${
                selected
                  ? 'border-jmwl-gold/60 bg-jmwl-gold/10 shadow-[0_0_0_1px_rgba(240,185,11,0.15)]'
            ...
            >
              <div className="flex items-center gap-2 text-sm font-semibold text-white">
                ...
                {option.badge ? (
                  <span className="rounded-full bg-jmwl-gold px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-black">
                    {option.badge}
                  </span>
                ) : null}
              </div>
